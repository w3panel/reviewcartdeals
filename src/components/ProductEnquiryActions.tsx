    ...
    <>
      ...
      <div className="mt-8 flex flex-col gap-3">
        <a
          ...
          className={`inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-6 py-4 text-xs font-bold uppercase tracking-wider text-primary-foreground transition-colors duration-200 hover:bg-primary-hover sm:gap-3 sm:text-sm ${
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primary px-6 py-4 text-xs font-bold uppercase tracking-wider text-primary-foreground transition-colors duration-200 hover:bg-primary-hover disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm"
        >
