...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[calc(5rem+env(safe-area-inset-bottom,0px))] right-4 z-40 flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-2xl transition-all duration-300 hover:scale-110 md:h-14 md:w-14 lg:bottom-8 lg:right-8"
