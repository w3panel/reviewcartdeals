        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-card border border-border rounded-2xl p-6 shadow-lg relative overflow-hidden">
            <div className="flex items-center gap-6 mb-6">
              <div className="flex flex-col items-center">
                ...
                <div className="text-sm font-semibold text-foreground mt-2 tracking-wide uppercase">
                  {ratingText}
                </div>
                <div className="text-[10px] text-muted-foreground mt-1 uppercase tracking-wider text-center">
          ...
          <div className="bg-card border border-primary/20 rounded-2xl p-6 shadow-lg relative overflow-hidden">
            ...
            <h3 className="font-serif text-lg font-bold text-foreground mb-2 leading-tight">
              Want the Best Deal for this Product?
            </h3>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="space-y-4 max-h-[800px] overflow-y-auto pr-2 custom-scrollbar">
            {reviews.map((review) => (
              <div
                key={review.id}
                className="bg-card border border-border rounded-2xl p-5 sm:p-6 shadow-md transition-colors hover:border-primary/30"
              >
          ...
          <button
            type="button"
            className="w-full mt-4 bg-transparent border border-primary text-primary py-3.5 rounded-xl text-xs font-bold tracking-widest uppercase hover:bg-primary hover:text-primary-foreground transition-colors"
          >
