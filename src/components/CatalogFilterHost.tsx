...
export function CatalogFilterHost({
  categories,
  brands,
  initialTotalDocs,
}: CatalogFilterHostProps) {
...
/** @deprecated Use CatalogFilterHost */
export const HomeFilterHost = CatalogFilterHost
